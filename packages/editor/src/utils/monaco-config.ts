...
/**
 * Applies shared Monaco configuration used by CheeseJS editor instances.
 */
export const configureMonaco = (
  monaco: Monaco,
  themeRegistry: Record<string, unknown> = {}
) => {
  // Register all themes
  Object.entries(themeRegistry).forEach(([name, themeData]) => {
