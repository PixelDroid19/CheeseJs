...
/** Minimal tab shape rendered by the reusable editor tab bar. */
...
/** Props for the reusable editor tab bar component. */
...
/**
 * Presentational Monaco tab bar with no direct store dependency.
 * The host application owns state and actions, this component only renders them.
 */
export function EditorTabBar({
  ...
  const handleDrop = (e: React.DragEvent, targetId: string) => {
    ...
    if (sourceId && sourceId !== targetId) {
      // Future implementation: drag and drop reordering.
    }
  };
