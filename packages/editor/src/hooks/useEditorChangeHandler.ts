...
/** Result returned by synchronous or asynchronous language detection. */
...
/** Parameters required to build the editor onChange handler. */
export interface UseEditorChangeHandlerParams {
...
/**
 * Creates the Monaco onChange handler that keeps code, cursor state,
 * language detection, and debounced execution in sync.
 */
