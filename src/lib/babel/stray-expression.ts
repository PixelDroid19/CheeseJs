        ...
        if (
          ...
          ((t.isIdentifier(expression.callee) &&
            (expression.callee.name === 'setTimeout' ||
              expression.callee.name === 'setInterval')) ||
            (t.isMemberExpression(expression.callee) &&
              t.isIdentifier(expression.callee.property) &&
              (expression.callee.property.name === 'setTimeout' ||
                expression.callee.property.name === 'setInterval')))
        ) {
          return;
        }
        ...
        const isPromiseChainWithConsole =
          ...
          expression.arguments.some(
            (arg) =>
              ...
              t.isIdentifier((arg as BabelTypes.MemberExpression).object, {
                name: 'console',
              })
          );
